...
A simple example lifecycle with serial density dependence is from [Moussalli and Hillborn (1986)](https://www.nrcresearchpress.com/doi/abs/10.1139/f86-014). This is a three stage life cycle
...
To cut down the amount of typing, first lets define the Beverton Holt function. 
