...
```{r}
total_fall_chinook <- flowline %>%
  filter(species == 'fall_chinook',
         spawn_dist == 'Yes' | Subbasin_num %in% mainstem.subs) %>%
  group_by(Habitat) %>%
  summarize(length = sum(Shape_Length / 1000, na.rm = T))

fall_chinook_ss <- total_fall_chinook$length[total_fall_chinook$Habitat == 'SmStream']
fall_chinook_lr <- total_fall_chinook$length[total_fall_chinook$Habitat == 'LgRiver']
fall_chinook_tidal <- total_fall_chinook$length[total_fall_chinook$Habitat == 'Tidal']
fall_chinook_total <- sum(total_fall_chinook$length, na.rm = T)

total_fall_chinook_fp <- fp2 %>%
  filter(hab.scenario %in% c('Current', 'Historical')) %>%
  group_by(hab.scenario, life.stage) %>%
  summarize(Area = sum(Area, na.rm = T))

curr_fp_summer <- total_fall_chinook_fp$Area[total_fall_chinook_fp$hab.scenario == 'Current' & total_fall_chinook_fp$life.stage == 'summer']
curr_fp_winter <- total_fall_chinook_fp$Area[total_fall_chinook_fp$hab.scenario == 'Current' & total_fall_chinook_fp$life.stage == 'winter']
hist_fp_summer <- total_fall_chinook_fp$Area[total_fall_chinook_fp$hab.scenario == 'Historical' & total_fall_chinook_fp$life.stage == 'summer']
hist_fp_winter <- total_fall_chinook_fp$Area[total_fall_chinook_fp$hab.scenario == 'Historical' & total_fall_chinook_fp$life.stage == 'winter']
...
fall_chinook_ss_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'SmStream']
fall_chinook_lr_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'LgRiver']
fall_chinook_tidal_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'Tidal']
fall_chinook_total_1 <- sum(scenario_1_length$length, na.rm = T)
...
fall_chinook_ss_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'SmStream']
fall_chinook_lr_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'LgRiver']
fall_chinook_tidal_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'Tidal']
fall_chinook_total_2 <- sum(scenario_2_length$length, na.rm = T)
...
fall_chinook_ss_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'SmStream']
fall_chinook_lr_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'LgRiver']
fall_chinook_tidal_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'Tidal']
fall_chinook_total_3 <- sum(scenario_3_length$length, na.rm = T)
...
There are `r fall_chinook_total` km of river habitat available to fall_chinook for rearing in the Chehalis River basin.  This includes `r fall_chinook_ss` km of small stream habitat, `r fall_chinook_lr` km of large river habitat, and `r fall_chinook_tidal` km of tidal habitat.  Additionally, there are `r curr_fp_summer` ha of summer floodplain habitat and `r curr_fp_winter` ha of winter floodplain habitat currently available to fall_chinook, while there were `r hist_fp_summer` ha of summer floodplain habitat and `r hist_fp_winter` ha of winter floodplain habitat available to fall_chinook historically. 

#### Stream length: 

Habitat | Length (km) | Scenario 1 length (km)| Scenario 2 length (km) | Scenario 3 length (km)
--------|-------------|-----------------------|------------------------|-----------------------
Total length | `r fall_chinook_total` | `r fall_chinook_total_1` | `r fall_chinook_total_2` | `r fall_chinook_total_3`
Small stream |  `r fall_chinook_ss` | `r fall_chinook_ss_1` | `r fall_chinook_ss_2` | `r fall_chinook_ss_3`
Large river | `r fall_chinook_lr` | `r fall_chinook_lr_1` | `r fall_chinook_lr_2` | `r fall_chinook_lr_3` 
Tidal |  `r fall_chinook_tidal` | `r fall_chinook_tidal_1` | `r fall_chinook_tidal_2` | `r fall_chinook_tidal_3`
