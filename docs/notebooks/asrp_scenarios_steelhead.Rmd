...
```{r}
total_steelhead <- flowline %>%
  filter(species == 'steelhead',
         spawn_dist == 'Yes' | Subbasin_num %in% mainstem.subs) %>%
  group_by(Habitat) %>%
  summarize(length = sum(Shape_Length / 1000, na.rm = T))

steelhead_ss <- total_steelhead$length[total_steelhead$Habitat == 'SmStream']
steelhead_lr <- total_steelhead$length[total_steelhead$Habitat == 'LgRiver']
steelhead_tidal <- total_steelhead$length[total_steelhead$Habitat == 'Tidal']
steelhead_total <- sum(total_steelhead$length, na.rm = T)

total_steelhead_fp <- fp2 %>%
  filter(hab.scenario %in% c('Current', 'Historical')) %>%
  group_by(hab.scenario, life.stage) %>%
  summarize(Area = sum(Area, na.rm = T))

curr_fp_summer <- total_steelhead_fp$Area[total_steelhead_fp$hab.scenario == 'Current' & total_steelhead_fp$life.stage == 'summer']
curr_fp_winter <- total_steelhead_fp$Area[total_steelhead_fp$hab.scenario == 'Current' & total_steelhead_fp$life.stage == 'winter']
hist_fp_summer <- total_steelhead_fp$Area[total_steelhead_fp$hab.scenario == 'Historical' & total_steelhead_fp$life.stage == 'summer']
hist_fp_winter <- total_steelhead_fp$Area[total_steelhead_fp$hab.scenario == 'Historical' & total_steelhead_fp$life.stage == 'winter']
...
steelhead_ss_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'SmStream']
steelhead_lr_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'LgRiver']
steelhead_tidal_1 <- scenario_1_length$length[scenario_1_length$Habitat == 'Tidal']
steelhead_total_1 <- sum(scenario_1_length$length, na.rm = T)
...
steelhead_ss_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'SmStream']
steelhead_lr_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'LgRiver']
steelhead_tidal_2 <- scenario_2_length$length[scenario_2_length$Habitat == 'Tidal']
steelhead_total_2 <- sum(scenario_2_length$length, na.rm = T)
...
steelhead_ss_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'SmStream']
steelhead_lr_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'LgRiver']
steelhead_tidal_3 <- scenario_3_length$length[scenario_3_length$Habitat == 'Tidal']
steelhead_total_3 <- sum(scenario_3_length$length, na.rm = T)
...
There are `r steelhead_total` km of river habitat available to steelhead for rearing in the Chehalis River basin.  This includes `r steelhead_ss` km of small stream habitat, `r steelhead_lr` km of large river habitat, and `r steelhead_tidal` km of tidal habitat.  Additionally, there are `r curr_fp_summer` ha of summer floodplain habitat and `r curr_fp_winter` ha of winter floodplain habitat currently available to steelhead, while there were `r hist_fp_summer` ha of summer floodplain habitat and `r hist_fp_winter` ha of winter floodplain habitat available to steelhead historically. 

#### Stream length: 

Habitat | Length (km) | Scenario 1 length (km)| Scenario 2 length (km) | Scenario 3 length (km)
--------|-------------|-----------------------|------------------------|-----------------------
Total length | `r steelhead_total` | `r steelhead_total_1` | `r steelhead_total_2` | `r steelhead_total_3`
Small stream |  `r steelhead_ss` | `r steelhead_ss_1` | `r steelhead_ss_2` | `r steelhead_ss_3`
Large river | `r steelhead_lr` | `r steelhead_lr_1` | `r steelhead_lr_2` | `r steelhead_lr_3` 
Tidal |  `r steelhead_tidal` | `r steelhead_tidal_1` | `r steelhead_tidal_2` | `r steelhead_tidal_3`
