...
mwmt_comp_plot <- ggplot(mwmt_comp, aes(x = meanT, y = mwmt)) +
  ...
  geom_smooth(method = 'lm', se = FALSE) +
  ylim(12, 28)+
  annotate("text", x = 21, y = 15, label = 'y = 1.02x + 3.81')+
  annotate("text", x = 21, y = 14, label = 'R^2 = .76') +
...
mdm_rear_comp_plot <- ggplot(mdm_rear_comp, aes(x = meanT, y = mdm_rear)) +
  ...
  geom_smooth(method = 'lm', se = FALSE) +
  ylim(12, 28)+
  annotate('text', x = 21, y = 15, label = 'y = .96x + .61') + 
  annotate('text', x = 21, y = 14, label = 'R^2 = .69') +
  annotate ('text', x = 21, y = 13, label = 'p ~ 0.0') +
  xlab('August ADA') +
  ylab('June 1-21 ADM')
