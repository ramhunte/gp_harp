...
mwmt_comp_plot <- ggplot(mwmt_comp, aes(x = meanT, y = mwmt)) +
  ...
  geom_smooth(method = 'lm', se = FALSE) +
  ylim(12, 28)+
  annotate("text", x = 21, y = 15, label = 'y = 1.02x + 3.81', size = 8)+
  annotate("text", x = 21, y = 14, label = 'R^2 = .76', size = 8) +
  annotate("text", x = 21, y = 13, label = "p ~ 0.0", size = 8)+
  xlab('August ADA') +
  ylab('7-DADM')+
  theme_bw() +
  theme(axis.text.x = element_text(size = 24),
        ...
        axis.title.y = element_text(size = 26),panel.grid.major = element_blank(),
...
mdm_rear_comp_plot <- ggplot(mdm_rear_comp, aes(x = meanT, y = mdm_rear)) +
  ...
  geom_smooth(method = 'lm', se = FALSE) +
  ylim(12, 28)+
  annotate('text', x = 21, y = 15, label = 'y = .96x + .61', size = 8) + 
  annotate('text', x = 21, y = 14, label = 'R^2 = .69', size = 8) +
  annotate ('text', x = 21, y = 13, label = 'p ~ 0.0', size = 8) +
  xlab('August ADA') +
  ylab('June 1-21 ADM')+
  theme_bw() +
