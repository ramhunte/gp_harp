...
source('misc/model_cleanup/new-functions.R')
...
source('misc/model_cleanup/edt_width.R')
source('misc/model_cleanup/3-temperature.R')
...
source('misc/model_cleanup/small_stream.R')
