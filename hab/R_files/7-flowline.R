...
flowline_noculv %<>%
  ...
  mutate(
         ...
         temp_diff_2040_rear = ifelse(species %in% c('spring_chinook', 'fall_chinook'),
                                      mwmt_to_mdm_func(F2040_temp - curr_temp),
                                      F2040_temp - curr_temp),
         temp_diff_2080_rear = ifelse(species %in% c('spring_chinook', 'fall_chinook'),
                                      mwmt_to_mdm_func(F2080_temp - curr_temp),
                                      F2080_temp - curr_temp),
         temp_diff_rear = ifelse(species %in% c('spring_chinook', 'fall_chinook'),
                            mwmt_to_mdm_func(curr_temp - hist_temp),
                            curr_temp - hist_temp),
         temp_diff_2040_prespawn = F2040_temp - curr_temp,
         temp_diff_2080_prespawn = F2080_temp - curr_temp,
         ...
         tm_2040_cc_only = rear_temp_mid,
         tm_2080_cc_only = rear_temp_late,
