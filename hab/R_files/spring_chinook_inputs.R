...
surv.base = c(rep(c(rep(.31, times = 8), rep(.46, times = 6), .31, .31, .46, .46, rep(NA, times = 18)), times = 2))
wood.surv.base = c(rep(c(rep(.31, times = 6), rep(.52, times = 2), rep(.46, times = 6), .52, .52, .46, .46, rep(NA, times = 18)), times = 2))
