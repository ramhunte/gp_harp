...
Plot of 2040 temperature change no action with growth everywhere

```{r}
basemap +
  geom_sf(data = temps_no_action_full_growth %>%
            filter(year == "chg_2040"),
          aes(color = temperature_change), lwd = 1.5) +
  scale_colour_manual(values = c("navy", "blue", "deepskyblue", "azure", "yellow", "orange", "red")) +
  theme(legend.text = element_text(size = 20),
...
ggsave("temperature_change_2040_no_action_full_growth.jpg", dpi = 300, width = 15, height = 12)
...
Plot of 2080 temperature change no action with growth everywhere
...
ggsave("temperature_change_2080_no_action_full_growth.jpg", dpi = 300, width = 15, height = 12)
